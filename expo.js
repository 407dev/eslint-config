...
// 1. Load Legacy Configs (Expo Universe & Prettier)
const legacyConfigs = compat.extends("universe", "prettier");
...
module.exports = [
    ...
    // --- TypeScript Overrides & Rules ---
    {
        ...
        rules: {
            ...
            // Disable things handled by Prettier or not needed
            "unicorn/no-null": 0,
            
            // Expo-specific abbreviations ignore list
